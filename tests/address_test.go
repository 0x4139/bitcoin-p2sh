...
func TestGenerateAddress(t *testing.T) {
	{
		...
		P2SHAddress, redeemScriptHex, err := btcp2sh.GenerateAddress(testM, testN, testPublicKeys)
		if err != nil {
			t.Fatalf("error while generating address, %s", err.Error())
		}
		if testAddress != P2SHAddress {
			CompareError(t, "Generated P2SH address different from expected address.", testAddress, P2SHAddress)
		}
		if testRedeemScriptHex != redeemScriptHex {
			CompareError(t, "Generated P2SH address different from expected address.", testRedeemScriptHex, redeemScriptHex)
		}
	}
	{
